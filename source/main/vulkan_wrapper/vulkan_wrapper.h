...
namespace Sirion
{
    ...
    private:
        ...
        {
            auto vertShaderCode = readFile("../../../source/shader/generated/vert.spv");
            auto fragShaderCode = readFile("../../../source/shader/generated/frag.spv");
        ...
        void createDepthResources()
        {
            ...
            depthImageView =
                createImageView(depthImage, depthFormat, vk::ImageAspectFlags(vk::ImageAspectFlagBits::eDepth));
