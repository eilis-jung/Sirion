...
vk::VertexInputBindingDescription Sirion::VulkanUtils::getBindingDescription()
{
...
std::array<vk::VertexInputAttributeDescription, 5> Sirion::VulkanUtils::getAttributeDescriptions()
{
...
vk::UniqueShaderModule Sirion::VulkanUtils::createShaderModule(vk::UniqueDevice&                 device,
