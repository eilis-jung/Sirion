Sirion is an MIT-licensed experimental 3D fluid solver framework. With Sirion, you can test mesh/particle-based simulation implementation, and debug your solver in real-time.
